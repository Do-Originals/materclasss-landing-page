...
export function FinalCta({ content }: { content: SiteContentType }) {
    ...
    <section className="py-24 bg-surface-dark relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 max-w-4xl relative z-10 text-center text-white">
        ...
        <CheckoutButton 
          ...
          text={content.course.showPriceInCta ? `${content.finalCta.cta} - ₹${content.course.price}` : content.finalCta.cta}
